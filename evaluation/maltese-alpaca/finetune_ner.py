...
def train(
    ...
    data_path: str = "evaluation/data/ner",
    output_dir: str = "./evaluation/maltese-alpaca/maltese-alpaca-ner",
    ...
    wandb_run_name: str = "ner-finetune",
    ...
    model.push_to_hub('kelseybonnici/maltese-alpaca-ner', token = os.getenv('HF_WRITE'), safe_serialization = False)
