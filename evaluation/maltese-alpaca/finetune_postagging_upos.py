...
def train(
    ...
    output_dir: str = "./evaluation/maltese-alpaca/maltese-alpaca-pos-upos",
    ...
    wandb_run_name: str = "upos-pos-finetune",
    ...
    model.push_to_hub('kelseybonnici/maltese-alpaca-pos-upos', token = os.getenv('HF_WRITE'), safe_serialization = False)
