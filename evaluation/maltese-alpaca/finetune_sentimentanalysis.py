...
def train(
    ...
    data_path: str = "evaluation/data/sentiment",
    output_dir: str = "./evaluation/maltese-alpaca/maltese-alpaca-sa",
    ...
    wandb_run_name: str = "sentimentanalysis-finetune",
    ...
    LORA_WEIGHTS = 'kelseybonnici/gendus'
    ...
    model.push_to_hub('kelseybonnici/maltese-alpaca-sa', token = os.getenv('HF_WRITE'), safe_serialization = False)
