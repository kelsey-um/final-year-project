...
def train(
    ...
    output_dir: str = "./evaluation/llama2/llama2-pos-upos",
    ...
    wandb_run_name: str = "llama2-pos-upos",
    ...
    model.push_to_hub('kelseybonnici/llama2-pos-upos', token = os.getenv('HF_WRITE'), safe_serialization = False)
