...
def train(
    ...
    output_dir: str = "./evaluation/llama2/llama2-sa",
    ...
    model.push_to_hub('kelseybonnici/llama2-sa', token = os.getenv('HF_WRITE'), safe_serialization = False)
