...
def train(
    ...
    output_dir: str = "./evaluation/llama2/llama2-ner",
    ...
    model.push_to_hub('kelseybonnici/llama2-ner', token = os.getenv('HF_WRITE'), safe_serialization = False)
