...
def train(
    ...
    output_dir: str = "./evaluation/llama2/llama2-pos-xpos",
    ...
    wandb_run_name: str = "llama2-pos-xpos",
    ...
    model.push_to_hub('kelseybonnici/llama2-pos-xpos', token = os.getenv('HF_WRITE'), safe_serialization = False)
