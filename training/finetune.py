...
def train(
    ...
    data_path: str = "training/data/alpaca_gpt4_data_mt_train.json",
    output_dir: str = "./training/lora-alpaca",
    ...
    # wandb_run_name: str = "run-final",
    wandb_run_name: str = "test-run",
    ...
    def generate_and_tokenize_prompt(data_point):
        ...
        if data_point['input']:
            ...
            full_prompt = """Hawn taħt hawn struzzjoni li tiddeskrivi kompitu. Ikteb tweġiba li tikkompleta t-talba kif xieraq.\n\n### Istruzzjoni: \n{instruction}\n\n### Risposta:\n{output}""".format(instruction=instruction, output=output)
    ...
    model.push_to_hub('kelseybonnici/maltese-alpaca', token = os.getenv('HF_WRITE'), safe_serialization = False)
